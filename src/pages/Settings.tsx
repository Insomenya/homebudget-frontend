...
import { SlidersHorizontal, UserCircle, CalendarClock } from 'lucide-react'
...
const sections = [
  ...
  { to: '/planning', icon: <CalendarClock size={20} />, title: 'Регулярные платежи', desc: 'Автоматические списания и поступления' },
]

const Settings = () => (
  <>
    <PageHeader title="Настройки" description="Справочники, участники и автоматизация" />
